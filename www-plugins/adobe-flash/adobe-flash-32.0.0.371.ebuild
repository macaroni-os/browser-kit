...
SRC_URI="
	nsplugin? ( https://fpdownload.adobe.com/pub/flashplayer/pdc/32.0.0.371/flash_player_npapi_linux.x86_64.tar.gz -> adobe-flash-32.0.0.371-npapi.x86_64.tar.gz )
	ppapi? ( https://fpdownload.adobe.com/pub/flashplayer/pdc/32.0.0.371/flash_player_ppapi_linux.x86_64.tar.gz -> adobe-flash-32.0.0.371-ppapi.x86_64.tar.gz )
"
SLOT="22"
