...
SRC_URI="
	amd64? ( https://archive.mozilla.org/pub/firefox/releases/124.0.1/linux-x86_64/en-US/firefox-124.0.1.tar.bz2 -> firefox-bin_x86_64-124.0.1.tar.bz2 )
	x86? ( https://archive.mozilla.org/pub/firefox/releases/124.0.1/linux-i686/en-US/firefox-124.0.1.tar.bz2 -> firefox-bin_i686-124.0.1.tar.bz2 )
