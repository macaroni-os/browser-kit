...
SRC_URI="${SRC_URI}
	amd64? ( https://archive.mozilla.org/pub/devedition/releases/99.0b7/linux-x86_64/en-US/firefox-99.0b7.tar.bz2 -> firefox-dev-bin_x86_64-99.0_beta7.tar.bz2 )
	x86? ( https://archive.mozilla.org/pub/devedition/releases/99.0b7/linux-i686/en-US/firefox-99.0b7.tar.bz2 -> firefox-dev-bin_i686-99.0_beta7.tar.bz2 )"
